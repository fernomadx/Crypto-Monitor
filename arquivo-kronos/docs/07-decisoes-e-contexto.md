...
- **Candle Dynamics backtest BTC 5y (2026-09)** — v1 INVALIDATED. v2 flat. **v2-short** padrão: risk **2%/max8x** + profit-lock **3R→1R** + hold 36h → **+$6960 (+696%, CAGR 51.4%, PF 2.89)** em $1000 (antes 1.5%/5x BE@2.5R = +250%). Fixo $100 = +3.6% (subuso). CLI `--sizing risk`.

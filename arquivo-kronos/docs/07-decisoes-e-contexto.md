...
- **Candle Dynamics backtest BTC 5y (2026-09)** — v1 INVALIDATED (−$182). v2 filtros: DD −$172, ainda flat (−$7). **v2-short** (só impulsão): PROMISING (+$14, PF 2.18). Código `lib/candle_dynamics/` + `vps/candle_dynamics_backtest.py --compare`.

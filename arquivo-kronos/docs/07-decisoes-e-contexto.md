...
- **Candle Dynamics backtest BTC 5y (2026-09)** — v1 INVALIDATED (−$182). v2 flat (−$7). **v2-short** otimizado: PROMISING (**+$35.80**, PF 2.87, DD $3.70) via hold 24h + BE@2.5R + stop≤1%. CLI `--compare`.

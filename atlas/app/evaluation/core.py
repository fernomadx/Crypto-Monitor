...
class DecisionEvaluator:
    ...
    async def evaluate_decision(self, decision_id: UUID) -> dict[str, Any]:
        ...
        if entry_price is None:
            return {"status": "skipped", "reason": "no entry price", "decision_id": str(decision_id)}
        ...
        if horizons_checked == 0:
            return {
                "status": "waiting_for_outcome_data",
                "decision_id": str(decision_id),
                "notes": "no candles available for any evaluation horizon yet",
            }
        ...
        evaluation = EvaluationRecord(
            ...
            notes="Auto-evaluation — no production weight updates",
